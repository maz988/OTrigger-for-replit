...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  const generateScheduledBlogPost = async () => {
    try {
      ...
      if (!isEnabled) {
        console.log('Auto-scheduling is disabled. Skipping scheduled blog post generation.');
        return {
          title: "Auto-Scheduling Disabled",
          slug: "auto-scheduling-disabled",
          content: "<p>Auto-scheduling is currently disabled. Enable it in settings to generate scheduled posts.</p>",

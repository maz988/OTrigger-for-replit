...
export async function registerRoutes(app: Express): Promise<Server> {
    ...
    try {
      ...
      if (!isEnabled) {
        ...
        const notificationPost = {
          ...
          metaDescription: "Auto-scheduling is currently disabled for blog post generation.",
          ...
          schema: {
            "@context": "https://schema.org",
            "@type": "Article",
            "headline": "Auto-Scheduling is Disabled",
            "description": "Auto-scheduling is currently disabled for blog post generation.",
            "author": {
              "@type": "Person",
              "name": "System"
            },
        ...
        // Save the notification post to database without going through createEnhancedPostStructure
        try {
  ...
  app.post("/api/admin/blog/generate-scheduled", authenticateAdmin, async (req, res) => {
    try {
      ...
      const blogPost = await generateScheduledBlogPost();
